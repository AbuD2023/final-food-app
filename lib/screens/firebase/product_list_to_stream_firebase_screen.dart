...
class ProductListFirebaseStreamScreen extends StatelessWidget {
  const ProductListFirebaseStreamScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Product List with Stream'),
      ),
      body: StreamBuilder<List<ProductModel>>(
        stream: ProductFirebase()
            .getAllProductsAsStream(), // Stream بدلاً من Future
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            ...
            onPressed: () async {
              log('product.docId!: ${product.docId!}');
              await ProductFirebase().deleteProductByDocId(product.docId!).then(
                (value) {
